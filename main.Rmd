...
JOB_CORES = parallel::detectCores() / 2
...
best_model <- svm_model_fn(
  ...
  formula = target ~ city_development_index + gender + relevent_experience + enrolled_university + education_level + major_discipline + experience + company_type + last_new_job + training_hours,
