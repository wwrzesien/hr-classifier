...
### Best result
```{r}
saveRDS(cv_result, paste(c("results/svm/cv_result_svm_rose", as.character(format(Sys.time(), "%Y-%m-%d_%H:%M:%S"))), collapse = '_'))
...
saveRDS(best_model, paste(c("results/svm/best_svm_rose_removed_miss_vals", as.character(format(Sys.time(), "%Y-%m-%d_%H:%M:%S"))), collapse = '_'))
```
...
### Best result
```{r}
saveRDS(forest_result, paste(c("results/random_forest/cv_result_rf_rose_100", as.character(format(Sys.time(), "%Y-%m-%d_%H:%M:%S"))), collapse = '_'))
...
preprocessed_data$train$target <- as.factor(preprocessed_data$train$target)
preprocessed_data$test$target <- as.factor(preprocessed_data$test$target)
...
saveRDS(best_model, paste(c("results/random_forest/best_rf_rose_100", as.character(format(Sys.time(), "%Y-%m-%d_%H:%M:%S"))), collapse = '_'))
```
