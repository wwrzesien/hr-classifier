...
train_transformed <- train_base %>% transform_types(categorical_vars_names) %>% remove_missing_vals %>% slice(1:1000)

# Remove useless columns
train_transformed <- train_transformed %>% select(!c("enrollee_id", "city", "company_size")) %>% divide_into_folds
